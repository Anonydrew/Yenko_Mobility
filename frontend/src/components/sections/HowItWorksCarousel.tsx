...
const cards: Card[] = [
  {
    ...
    text: 'Get Yenko free on the App Store or Google Play. One app for e-bikes, shared rides, delivery and more.',
  ...
  },
  {
    ...
    text: 'Sign up with your phone number, add MoMo or a card, and verify your student email for student prices.',
    meta: 'Ghana Card not needed to ride',
    image: media.students.src,
  },
  {
    title: 'Find your ride',
    text: 'See available e-bikes and shared rides near you on the live map, with prices and battery levels.',
    meta: 'Reserve a bike free for 10 minutes',
    image: media.eBike.src,
  },
  {
    title: 'Scan and ride',
    text: 'Scan the QR code to unlock, or meet your shared ride at the pick-up point, and you’re on your way.',
    meta: 'Pedal assist up to 25 km/h',
    image: media.riders.src,
  },
  {
    title: 'Park and end your ride',
    text: 'Park inside a blue zone, close the lock and snap a photo. Your receipt appears straight away.',
    meta: 'More than 120 parking zones',
    image: media.parking.src,
  },
];

/** Webflow-style carousel: three cards in view, the fourth peeking in, arrows to move through all five. */
export default function HowItWorksCarousel() {
  ...
  return (
    <section aria-labelledby="how-it-works-title" className="overflow-hidden bg-black py-16 sm:py-24">
      <Container className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 id="how-it-works-title" className="mt-3 max-w-3xl text-display-lg font-bold">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex h-11 w-11 items-center justify-center rounded-full bg-white text-onbrand transition-opacity hover:bg-ink-soft disabled:opacity-30"
          >
      ...
      >
        {cards.map((card, index) => (
          <li
            ...
            className="relative aspect-[3/4] w-[82vw] shrink-0 snap-start overflow-hidden rounded-3xl border border-line bg-surface-muted sm:aspect-[2/3] sm:w-[calc((100vw-5rem)/2.3)] lg:w-[calc((min(100vw,84rem)-5rem-2rem)/3.3)]"
          >
            ...
            <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6">
              ...
              <h3 className="mt-3 text-xl font-medium tracking-tight text-white">{card.title}</h3>
      ...
      <p className="mt-10 px-5 text-center text-sm text-ink-muted">
        Want the details?{' '}
        <Link to="/how-it-works" className="text-ink underline underline-offset-4">
